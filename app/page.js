...
export default function Home() {
  ...
  <span className="pl-2">Global Reach.</span>
    ...
    <h3 className="text-2xl md:text-3xl lg:text-4xl text-gray-100 pb-2 font-sem">From <span style={{ color: '#1DB954' }}>YYC</span> to the World.</h3>
  ...
  <button className="text-xl md:text-2xl lg:text-3xl rounded-3xl bg-green-500 text-gray-100 px-12 py-2 mt-6">sign up</button>
</main>
    </>
  );
}
