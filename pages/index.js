    ...
    <>
      ...
      <main className="flex flex-col items-center justify-center h-screen">
        <div className="text-center px-4 space-y-2 md:space-y-1">
              ...
              <span className="text-shadow">
                <div className="flex justify-center text-4xl md:text-5xl lg:text-6xl text-gray-100 mt-44 tracking-wider">
                  <span
                    style={{
                      background:
                        "linear-gradient(to right, darkgray, lightgray)",
          ...
          <h3 className="text-2xl md:text-3xl lg:text-4xl text-gray-300 pb-2 tracking-wider">
            From <span style={{ color: "#1DB954" }}>YYC</span> to the World.
          </h3>
          <img
            src="/spotifylogo.png"
            alt="Spotify Logo"
